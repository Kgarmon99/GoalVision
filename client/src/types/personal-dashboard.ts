...
export const DEFAULT_METRICS_TEMPLATE: DashboardMetric[] = [
  { id: 'm1', label: 'Schools Live', current: 5, target: 2500, previous: 4, deadline: '2026-12-01', unit: '' },
  { id: 'm2', label: 'Districts', current: 4, target: 100, previous: 3, deadline: '2026-12-01', unit: '' },
  { id: 'm3', label: 'Active Users', current: 300, target: 3000000, previous: 300, deadline: '2026-12-01', unit: 'M' },
  { id: 'm4', label: 'Revenue', current: 0, target: 20000000, previous: 0, deadline: '2026-12-01', unit: '$M' },
];
