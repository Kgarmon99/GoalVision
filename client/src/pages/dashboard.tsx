      ...
      <main className="flex-1 py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-3">
                <div className="bg-white rounded-md shadow-sm border border-gray-200 p-2">
                  ...
                  <span className="text-sm font-medium ml-1">{lastUpdated}</span>
                </div>
                <Button 
                  variant="outline"
          ...
          <section className="mb-8">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Main Goals Progress</h2>
            {isLoading ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[1, 2, 3, 4].map((_, index) => (
                  <div key={index} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 h-32 animate-pulse">
